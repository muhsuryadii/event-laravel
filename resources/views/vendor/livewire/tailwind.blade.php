            ...
            <span>
              ...
              @if ($paginator->onFirstPage())
                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                  <span
                    class="relative inline-flex h-full cursor-default items-center rounded-l-md border border-gray-300 bg-gray-300 px-2 py-2 text-sm font-medium leading-5 text-gray-500"
                    aria-hidden="true">
                  ...
                  <span
                    ...
                    @if ($page == $paginator->currentPage())
                      <span aria-current="page">
                        <span
                          class="relative -ml-px inline-flex cursor-default select-none items-center border border-gray-300 bg-gray-200 px-4 py-2 text-sm font-medium leading-5 text-gray-500">{{ $page }}</span>
                      </span>
                    @else
            ...
            <span>
              ...
              @else
                <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                  <span
                    class="relative -ml-px inline-flex h-full cursor-default items-center rounded-r-md border border-gray-300 bg-gray-300 px-2 py-2 text-sm font-medium leading-5 text-gray-500"
                    aria-hidden="true">
                    <svg class="h-[20px] w-[20px]" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd"
                        d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
