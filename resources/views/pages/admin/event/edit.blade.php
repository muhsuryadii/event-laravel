  ...
  <div class="row">
    <div class="col-12">
      <div class="card mb-4">
        ...
        <form action='{{ route('admin_events_update', $event->uuid) }}' method="POST" enctype="multipart/form-data"
          class="p-[1.5rem]" id='formEditEvent'>
          @csrf
          @method('put')
            ...
            <div class="col-md-6 col-12">
              ...
              <div class="mb-4">
                ...
                <input type="datetime-local" class="form-control @error('waktu_acara') is-invalid @enderror"
                  id="waktu_acara" name="waktu_acara" required
                ...
                <div class="radio d-flex mt-3">
                  ...
                  <div class="form-check">
                    <input class="form-check-input ticketPrice" type="radio" name="harga_tiket" value='bayar'
                      id="picePay" {{ $event->harga_tiket != 0 ? 'checked' : ' ' }}>
            ...
            <div class="col-md-6 col-12">
              ...
              <div class="mb-3">
                ...
                <img class="img-preview img-fluid col-sm-5 d-block mx-auto mt-3 mb-3 rounded-md shadow-md"
                  ...
                  loading="lazy">
                <input type="hidden" class='d-none' name="oldImage" value="{{ $event->famplet_acara_path }}">
          ...
          {{-- Tipe Acara --}}
          <div class="mb-4">
            <label for="name" class="form-label @error('nama_event') is-invalid @enderror text-sm">Tipe
              Event</label>
            <div class="radio d-flex mt-3">
              <div class="form-check mb-3 mr-3">
          ...
          <button type="submit" id='buttonEditEvent' class="btn btn-primary w-100 btn-simpan mb-4">Update</button>
        </form>
      </div>
    </div>
  </div>
